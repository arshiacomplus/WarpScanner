...
### Run the following code in the Tremax App
...
## 1. AP scanner is IPv4, IPv6

##### ▫️ Ability to save IPs Version Four in Storage/Emulated/0/and File called Result.CSV
...
##### Note: You can clean IP for Vahid panel (with Inter) and BPB panel (with comma)

##### Say in the rifle file

##### Then you enter the number one (IPEP Version Four)

<br><br/>

## 2. Receive Configuration Wirecard

▫️The a few more times if you get a configuration of the wires to Error Time Out<br><br/>

## 3. Receive Wiregard Configuration without the need to scan IP

(For people to be erecard Best_result[0]Are eating) 
 If so, you can first scan from other IP scanners 
 And after you hit the option three you will be asked if you enter the IP with the port or if you enter n it will select the IP I already.
...
If you ate Error August, test a few more times<br><br/>

## 5. To receive the Wireguard Configuration for use in V2Ray and Mahsang

> This is for those who take the Requests<https://t.me/arshia_mod_fun/298>

By entering option 1 and after that 
 You can get the IP version of the glass, which is also implemented for Mahsa and Vittori for option 2 for Mahsa and Vittori
...
## 6. To get a wirecard configgling for Vittori and Mahsa Angi and ... no scan IP

If you hit n it will choose the ipy I already left
 Otherwise 
...
Ask you whether the sites (Panda Kung Fu) are blocked or not<br><br/>

## 8. You can take the sub -vein of that V2ray for v2ray or mahsang

<br><br/>

## 9. You can make a cut shorts
...
## 10. Open this option Configuration File`.conf`WiGeard is made for Windscraib and Weir

## 11. by hitting this option you can get the Configle Wayer for Nika Fig.

## 12. by hitting this option you can get a wigger configgling for Nika Annie without the need to scan IP

## 13. For the conquer wow with noise values ​​for Nika and Mahsa Angi
...
<b>Trx:</b><br><a href="https://link.trustwallet.com/send?coin=195&address=TKUpVDG5DqLDUSg3X1hhidRPuhm1GmqZ2G">TKUpVDG5DqLDUSg3X1hhidRPuhm1GmqZ2G</a><br><b>USDT:</b><br><a href="https://link.trustwallet.com/send?coin=60&address=0xBcE10b8B572DdFAc53855879ebCE9942296553A3&token_id=0xdAC17F958D2ee523a2206206994597C13D831ec7">0 Busbasi 10, with a thunderbolt.</a>

## Support the project

<b>If you like my project, you can support my project by giving stars and giving up and introducing your friends</b>
