...
try:
    ...
    label_up=ttk.Label(root_crypto,style="Costum.TLabel" ,text=f"Something went Wrong with cryptography\n\n You can just sacn IP")
    ...
    for _  in range(5):
        if t==0:
            ...
            try:
                ...
                sp_label.config(text="Creating result.txt ...")
                root_splash.update()
...
def main():
    ...
    button = tk.Button(rootmain, width=5, padx=6, pady=4, bd=1, text="ipV4",command=main_move)
...
'''
            ...
            def check_ac(i):
                ...
                if i_ip_scan==True and is_v2ray==True:
                ...
                if i_ip_scan == False and is_v2ray==True:
                    best_result = sorted_results[0] if sorted_results else None
...
'''
    ...
    if i_ip_scan ==True:
        ...
        button1 = tk.Button(rootwire_confing, width=5, padx=6, pady=4, bd=1, text="start", command=main_move)
        button1.pack(fill=tk.X,side=tk.BOTTOM)
        button1.bind("<Enter>", hand2)
        ...
        button = tk.Button(rootwire_confing, width=5, padx=6, pady=4, bd=1, text="ipV4", command=main_move)
        button.pack(fill=tk.X,side=tk.BOTTOM)
        button.bind("<Enter>", hand2)


        button1 = tk.Button(rootwire_confing, width=5, padx=6, pady=4, bd=1, text="ipV6", command=main_move_v6)
        button1.pack(fill=tk.X,side=tk.BOTTOM)
        button1.bind("<Enter>", hand2)
...
def mainactivity():
    ...
    def About():
        ...
        label_mew=ttk.Label(root_about,style="Costump.TLabel",text="New version v0.3.6:\nGood news:\n\nAdvance seeting\n\nBetter style\n\nBad news:\n\nApi zeroteam Deleted ")
    ...
    def Setting():
        def sumbit_f():
            ...
            with open("warp_setting" , "r") as f:
                warp1=f.readlines()
            with open("warp_setting" , "w") as f:
                warp1[7]=ping_range_get
                for i in warp1:
                    f.write(i)

            interval_see=warp1[4]
            interval_see=int(interval_see[:interval_see.index("\n")])
        ...
        canvas=tk.Canvas(slide_frame)
        canvas.pack(side=tk.LEFT,fill=tk.Y)

        scrollbar = ttk.Scrollbar(slide_frame, orient="vertical",command=canvas.yview)
        ...
        spu_label=ttk.Label(inner_frame,style="C.TLabel",text="Scan  speed")
        spu_label.pack(fill=tk.X)
        scrollbar.config(command=spu_label)
        style=ttk.Style()
        ...
        checkbox1 = ttk.Checkbutton(inner_frame, text="Faster", variable=checkbox_var, onvalue=1, offvalue=0)
        checkbox1.pack(ipady=5,fill=tk.X)
        checkbox1.bind("<Enter>", hand2)

        checkbox2 = ttk.Checkbutton(inner_frame, text="Slower", variable=checkbox_var, onvalue=0, offvalue=0)
        checkbox2.pack(ipady=5,fill=tk.X)
        checkbox2.bind("<Enter>", hand2)


        save_ch=ttk.Label(inner_frame,style="C.TLabel",text="Save result")
        ...
        checkbox3 = ttk.Checkbutton(inner_frame, text="Yes", variable=checkbox_var2, onvalue=1, offvalue=0)
        checkbox3.pack(ipady=5,fill=tk.X)
        checkbox3.bind("<Enter>", hand2)

        checkbox4 = ttk.Checkbutton(inner_frame, text="No", variable=checkbox_var2, onvalue=0, offvalue=0)
        checkbox4.pack(ipady=5,fill=tk.X)
        checkbox4.bind("<Enter>", hand2)

        which_panel=ttk.Label(inner_frame,style="C.TLabel",text="Which panel" )
        ...
        checkbox5 = ttk.Checkbutton(inner_frame, text="bpb", variable=checkbox_var3, onvalue=1, offvalue=0)
        checkbox5.pack(ipady=5,fill=tk.X)
        checkbox5.bind("<Enter>", hand2)

        checkbox6 = ttk.Checkbutton(inner_frame, text="vahid", variable=checkbox_var3, onvalue=0, offvalue=0)
        checkbox6.pack(ipady=5,fill=tk.X)
        checkbox6.bind("<Enter>", hand2)

        checkbox7 = ttk.Checkbutton(inner_frame, text="with score", variable=checkbox_var3, onvalue=2, offvalue=0)
        checkbox7.pack(ipady=5,fill=tk.X)
        checkbox7.bind("<Enter>", hand2)

        Wh_api=ttk.Label(inner_frame,style="C.TLabel",text="Which api")
        ...
        checkbox8 = ttk.Checkbutton(inner_frame, text="api 1/not work", variable=checkbox_var4, onvalue=1, offvalue=0)
        checkbox8.pack(ipady=5,fill=tk.X)
        checkbox8.bind("<Enter>", hand2)

        checkbox9 = ttk.Checkbutton(inner_frame, text="api 2", variable=checkbox_var4, onvalue=0, offvalue=0)
        checkbox9.pack(ipady=5,fill=tk.X)
        checkbox9.bind("<Enter>", hand2)


        ping_lab=ttk.Label(inner_frame,style="C.TLabel",text="ping range\n")
        ...
        ping_range=ttk.Entry(inner_frame)
        ping_range.pack( padx=10, pady=10,fill=tk.X)

        ping_range.insert(0, num33)
# icmp=pinging(ip, count=count_see ,interval=interval_see,timeout=timeout_see,family="ipv4" )

        advane=ttk.Label(inner_frame,style="C.TLabel",text="<Advance>\n")
        ...
        num33=num33[4]
        num33=num33[:num33.index("\n")]
        icmp_interval=ttk.Label(inner_frame,style="C.TLabel",text="icmp_interval")
        icmp_interval.pack(fill=tk.X)


        interval=ttk.Entry(inner_frame)
        ...
        num33=num33[5]
        num33=num33[:num33.index("\n")]
        icmp_count=ttk.Label(inner_frame,style="C.TLabel",text="icmp_ping_count")
        icmp_count.pack(fill=tk.X)


        count=ttk.Entry(inner_frame)
        ...
        icmp_timeout=ttk.Label(inner_frame,style="C.TLabel",text="icmp_timeout")
        icmp_timeout.pack(fill=tk.X)



        timeout=ttk.Entry(inner_frame)
        timeout.pack( padx=10, pady=10,fill=tk.X)

        timeout.insert(0, num33)
        
        submit=ttk.Button(inner_frame, text="save", command=sumbit_f)
        submit.pack(pady=5,ipady=5,fill=tk.X)
        submit.bind("<Enter>", hand2)

            
        nnnnnn=ttk.Label(inner_frame,style="C.TLabel",text="\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n")
        nnnnnn.pack(fill=tk.X)
    ...
    def check_up():
            ...
            if ret[0]  == True:
                ...
                label_up=ttk.Label(rootupdate,style="Costum.TLabel", text="New version v0.3.6:\nGood news:\n\nAdvance seeting\n\nBetter style\n\nBad news:\n\nApi zeroteam Deleted ")
                label_up.pack(fill=tk.X)
