...
def mainactivity():
    ...
    def About():
        ...
        label_mew=ttk.Label(root_about,style="Costump.TLabel",text="New version v0.3.5:\nGood news:\n\nAdvance seeting\n\nBetter style\n\nBad news:\n\nApi zeroteam Deleted ")
...
# icmp=pinging(ip, count=count_see ,interval=interval_see,timeout=timeout_see,family="ipv4" )
    ...
    def check_up():
            ...
            if ret[0]  == True:
                ...
                label_up=ttk.Label(rootupdate,style="Costum.TLabel", text="New version v0.3.5:\nGood news:\n\nAdvance seeting\n\nBetter style\n\nBad news:\n\nApi zeroteam Deleted ")
                label_up.pack(fill=tk.X)
