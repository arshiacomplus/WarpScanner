...
def mainactivity():
    ...
    def parse_configs(conifg,num=0,cv=1):
        ...
        PASS,
            ...
            PORT=conifg.split(start)[1].split("@")[1].split(":")[1].split("?")[0]
    ...
    def toggle_menu_r():
            ...
            if menu_frame.winfo_x() == rootmainactivity.winfo_screenwidth():
                ...
                menu_frame.place(x=rootmainactivity.winfo_width() - menu_frame.winfo_width(), y=0)
                rootmainactivity.update()
            else:
    ...
    def About():
        ...
        label_mew=ctk.CTkLabel(root_about,text="New version v0.4.7:\nGood news:\n\nbetter Graphic\n\nfix Bugs\n\nBad news:\n\nNotihng:))")
    ...
    def check_up():
            ...
            def on_go():
                ...
                if ret[0]  == True:
                    ...
                    label_up=ctk.CTkLabel(rootupdate ,font=("Helvetica", 12, "bold"), text="New version v0.4.7:\nGood news:\n\nbetter Graphic\n\nfix Bugs\n\nBad news:\n\nNotihng:))")
                    label_up.pack(fill=tk.X)
...
#     labelmain.pack()
    ...
    versoin_la=ctk.CTkButton(fram_on_top_ver  ,  text="v0.4.7",state="disable",fg_color="#2BFED0",text_color="black")
