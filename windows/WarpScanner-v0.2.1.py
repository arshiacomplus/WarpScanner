...
#     labelmain.pack()
    ...
    button = ttk.Button(rootmainactivity,width=25, text="scan ip", command=which_Cpu_speed)
    button.pack(ipady=5,pady=10)


    button.bind("<Enter>", hand2)

    button1 = ttk.Button(rootmainactivity,width=25, text="wireguard config", command=wireguard_config)
