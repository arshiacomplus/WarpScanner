...
def mainactivity():
    ...
    tabview.tab("main").bind("<Configure>", on_tab_change)
    with open("warp_setting", "r") as f:
        tep=f.readlines()
    ...
    def toggle_menu_r():
            ...
            if menu_frame.winfo_x() == rootmainactivity.winfo_screenwidth():
                ...
                for i in range(rootmainactivity.winfo_width()-225, rootmainactivity.winfo_width() - menu_frame.winfo_width()):
    ...
    def About():
        ...
        label_mew=ctk.CTkLabel(root_about,text="New version v0.4.6:\nGood news:\n\nbetter Graphic\n\nfix Bugs\n\nBad news:\n\nNotihng:))")
    ...
    def check_up():
            ...
            def on_go():
                ...
                if ret[0]  == True:
                    ...
                    label_up=ctk.CTkLabel(rootupdate ,font=("Helvetica", 12, "bold"), text="New version v0.4.6:\nGood news:\n\nbetter Graphic\n\nfix Bugs\n\nBad news:\n\nNotihng:))")
                    label_up.pack(fill=tk.X)
...
#     labelmain.pack()
    ...
    versoin_la=ctk.CTkButton(fram_on_top_ver  ,  text="v0.4.6",state="disable",fg_color="#2BFED0",text_color="black")
