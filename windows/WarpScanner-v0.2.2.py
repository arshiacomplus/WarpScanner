...
def main():
    ...
    button = tk.Button(rootmain, width=5, padx=6, pady=4, bd=1, text="ipV4", command=main_move,fg="#f0f0f0", bg="#414141")
    button.pack(fill=tk.X,side=tk.BOTTOM)
    button.bind("<Enter>", hand2)


    button1 = tk.Button(rootmain, width=5, padx=6, pady=4, bd=1, text="ipV6", command=main_move_v6,fg="#f0f0f0", bg="#414141")
    button1.pack(fill=tk.X,side=tk.BOTTOM)
    button1.bind("<Enter>", hand2)


    button3 = tk.Button(rootmain, width=5, padx=6, pady=4, bd=1, text="clean", command=clean,fg="#f0f0f0", bg="#414141")
...
def mainactivity():
    ...
    def Setting():
        ...
        checkbox7 = tk.Checkbutton(slide_frame, text="with score", variable=checkbox_var3, onvalue=2, offvalue=0)
        checkbox7.pack(pady=10)
